...
function App() {
  ...
  return (
    <>
      <div className="bg-[#1f2020] flex flex-col overflow-x-auto w-full">
        <header className="fixed top-0 left-0 w-full z-50 right-0 bg-[#2d2d2d] flex justify-between flex-col sm:flex-col">
          <nav>
        ...
        <main className="flex flex-col">
          <div className="flex flex-col md:flex-row md:h-screen" id="home">
            ...
            <div className="flex flex-col justify-center text-start text-white font-sans font-bold text-xl gap-14 md:w-3/5 my-10 md:my-0 mx- 3 md:mx-5">
              ...
              <div className="flex md:flex-row gap-8 justify-center md:justify-start">
                ...
                <button className="bg-[#2d2d2d] text-white py-2 px-5 rounded-[5px] hover:bg-[#1f2020] hover:text-white hover:border-2 hover:border-[#2d2d2d] transition duration-500 ease-in-out hover:rounded-[5px]">
                  Hire Me
                </button>
              </div>
            </div>
          </div>
          <div className="h-auto md:h-screen px-10 md:pt-24" id="about-us">
          ...
          <div className="flex flex-col h-screen pt-36" id="projects">
            <h1 className="py-[30px] md:py-0 flex text-center justify-center items-center text-3xl font-bold text-white">
              <span>
          ...
          <div className="flex flex-col h-screen pt-36" id="skill">
